...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-white pt-20 md:pt-24 lg:pt-28 pb-6 md:pb-10 relative overflow-hidden w-full">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-16 py-6 md:py-16">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full min-w-0">
          ...
          >
            <div className="relative w-full max-w-[340px] xs:max-w-[380px] sm:max-w-[460px] md:max-w-[560px] mx-auto lg:max-w-[650px] lg:mr-auto lg:ml-0">
          ...
          <motion.div
            ...
            className="space-y-5 md:space-y-8 order-last lg:order-first w-full min-w-0 lg:pl-16"
          >
            {/* Language Badge */}
            <div className="mb-2">
              <LanguageBadge />
            ...
            <div className="space-y-2 md:space-y-3 w-full">
              <motion.img
                ...
                alt="Bisnis Kamu"
                className="h-[50px] sm:h-[58px] md:h-[70px] lg:h-[62px] object-contain object-left max-w-full"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                />
                <motion.div
                  className="bg-[#272727] rounded-lg md:rounded-xl px-3 md:px-6 py-2 md:py-4 h-[58px] sm:h-[62px] md:h-[68px] lg:h-[62px] flex items-center flex-shrink-0"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ delay: 0.6 }}
                >
                  <img src="/Assets/Hadir.png" alt="Hadir" className="h-[38px] sm:h-[40px] md:h-[44px] lg:h-[40px] object-contain" />
                </motion.div>
              </div>
            </div>
            ...
            {/* Description */}
            <motion.p
              className="text-[#828282] text-[13px] sm:text-[15px] md:text-[18px] lg:text-[15px] max-w-full sm:max-w-[587px] lg:max-w-[460px] leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {/* CTA Buttons */}
            <motion.div
              className="flex flex-row gap-2 sm:gap-3 md:gap-4 pt-2 md:pt-6 lg:max-w-[400px]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex-1 space-y-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="text-white w-full px-3 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 lg:py-3 rounded-xl font-semibold text-[13px] sm:text-[16px] md:text-[18px] lg:text-[14px] flex items-center justify-center shadow-lg text-center"
